package body Py_Bind.Bounded_Array is
   ...
   function Set_Item (Args : Py_Args) return PyObject is
      Self : constant Py_Array_Value.Val_Access :=
        Py_Array_Value.Access_Desc.Get_Arg (Args, 1);
   ...
   begin
      ...
      return Element_Desc.P_To_Python_Unsafe (Self (Key)).Py_Data;
   end Get_Item;
