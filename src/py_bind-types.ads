...
package Py_Bind.Types is
   ...
   package No_Type is new Py_Bind.Py_Type_Descriptor (Dummy_Type);
   package String_Type is new Py_Bind.Py_Type_Descriptor (String);
   package Int_Type is new Py_Bind.Py_Type_Descriptor (Integer);
