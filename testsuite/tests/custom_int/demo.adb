...
package body Demo is
   ...
   function Get_X (Self : Point) return Point_Coord is (Self.X);

   -----------
   -- Set_X --
   -----------

   procedure Set_X (Self : in out Point; X : Point_Coord) is
   begin
      Self.X := X;
   end Set_X;
   ...
   function Get_Y (Self : Point) return Point_Coord is (Self.Y);

   -----------
   -- Set_Y --
   -----------

   procedure Set_Y (Self : in out Point; Y : Point_Coord) is
   begin
      Self.Y := Y;
   end Set_Y;
